...
namespace SmartMenu.DAO.Migrations
{
    ...
    [Migration("20240628170227_UpdateEntityNameField")]
    partial class UpdateEntityNameField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartMenu.Domain.Models.Layer", b =>
                {
                    b.HasOne("SmartMenu.Domain.Models.LayerItem", "LayerItem")
                        .WithMany()
                        .HasForeignKey("LayerItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
